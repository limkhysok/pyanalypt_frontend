...
import { Target, Zap, Shield, Heart, Users, BarChart2, Clock, TrendingUp } from "lucide-react";
...
// Client Component — isolated to only what needs whileInView scroll animations.
// No user interactivity (no useState), but motion/react requires the browser for
// IntersectionObserver-based whileInView triggers.
                    ...
                    <div className="space-y-6 max-w-xl">
                        ...
                        <div className="space-y-4 text-base md:text-lg text-muted-foreground leading-relaxed font-medium">
                            <p>
                                ...
                                on data science teams, custom dashboards, and BI consultants. The result? A 30-page
                                report that took 3 weeks to produce.
                            </p>
                            <p>
                                Small and mid-size business owners have the same data — sales records, customer logs,
                                inventory files — but none of the infrastructure. They&apos;re making
                                half-a-million-dollar decisions with a six-year-old spreadsheet and a gut feeling.
                            </p>
                            <p>
                                That&apos;s the gap we&apos;re here to close.{" "}
                                <span className="text-foreground font-bold">
                                    Every business owner deserves the same analytical power, regardless of technical background.
                                </span>
                            </p>
                        </div>
                    </div>
            ...
            <ScrollReveal>
                <div className="space-y-12">
                    ...
                    <div className="relative max-w-2xl mx-auto">
                        <div
                            className="absolute left-9 top-10 bottom-10 w-px bg-linear-to-b from-blue-500/30 via-violet-500/20 to-emerald-500/30 hidden sm:block"
                            aria-hidden="true"
                        />
                            ...
                            {timeline.map((item, i) => (
                                ...
                                >
                                    <div className="shrink-0 w-14 h-14 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center">
                                        <span className="text-[10px] font-black text-blue-500 text-center leading-tight">
                                            {item.year}
                                        </span>
                                    </div>
