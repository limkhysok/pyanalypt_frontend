		...
		>
			<form onSubmit={handleSubmit} className="space-y-5">
				...
				<div className="space-y-4">
					<div className="space-y-2">
						...
						<div className="relative group/input">
							<Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-4 w-4 text-muted-foreground group-focus-within/input:text-foreground transition-colors pointer-events-none z-10 opactiy-40" />
							<Input
								id="email"
								type="email"
								value={email}
					...
					<div className="space-y-2">
						<div className="flex items-center justify-between ml-1">
							<Label
								htmlFor="password"
								className="text-[10px] font-black uppercase tracking-[0.2em] text-muted-foreground opacity-60"
							>
								Password
							</Label>
							<Link href="/about" className="text-[9px] font-black text-muted-foreground/30 hover:text-foreground transition-colors uppercase tracking-widest">
								Recover?
							</Link>
						</div>
						<div className="relative group/input">
				...
				<p className="text-center text-[10px] font-black text-muted-foreground mt-6 uppercase tracking-widest opacity-60 flex items-center justify-center gap-2">
					New User?
					<Link href="/register" className="text-foreground hover:underline flex items-center gap-1.5">
