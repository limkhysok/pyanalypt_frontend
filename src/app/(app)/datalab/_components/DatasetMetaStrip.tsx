    ...
    return (
        <div className="flex items-stretch gap-px bg-border border border-border flex-wrap">
            <div className="bg-background px-4 py-2.5 flex flex-col gap-1 min-w-45 flex-1">
                <span className="text-[11px] font-black text-muted-foreground tracking-widest leading-none">Dataset Name</span>
            ...
            <div className="bg-background px-4 py-2.5 flex flex-col gap-1 min-w-25">
                <span className="text-[11px] font-black text-muted-foreground tracking-widest leading-none">Format</span>
            ...
            <div className="bg-background px-4 py-2.5 flex flex-col gap-1 min-w-25">
                <span className="text-[11px] font-black text-muted-foreground tracking-widest leading-none">Storage</span>
                <div className="flex items-center gap-1.5 leading-none">
            ...
            <div className="bg-background px-4 py-2.5 flex flex-col gap-1 min-w-27.5">
                <span className="text-[11px] font-black text-muted-foreground tracking-widest leading-none">Total Rows</span>
                <div className="flex items-center gap-1.5 leading-none">
            ...
            <div className="bg-background px-4 py-2.5 flex flex-col gap-1 min-w-27.5">
                <span className="text-[11px] font-black text-muted-foreground tracking-widest leading-none">Total Columns</span>
                <div className="flex items-center gap-1.5 leading-none">
