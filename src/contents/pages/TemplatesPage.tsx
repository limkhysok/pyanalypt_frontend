...
const RealisticChart = ({ type, isHovered }: { type: string, isHovered: boolean }) => {
    // Generate dummy data that simulates a 'trending' market rather than pure noise
        ...
        if (isHovered) {
            const interval = setInterval(() => {
                setData(prev => {
                    ...
                    // Simulate a trend with occasional 'manipulation' spikes
                        ...
                        >
                            <div className="group relative w-full h-full bg-card/60 backdrop-blur-xl rounded-[2.5rem] border-2 border-zinc-300 dark:border-zinc-800 overflow-hidden transition-all duration-500 hover:border-primary/50 hover:shadow-[0_0_80px_-20px_rgba(32,190,255,0.15)]">
                                ...
                                <div className="relative w-full h-[310px] overflow-hidden bg-secondary/5">
                                    ...
                                    <div className="absolute inset-0 flex items-center justify-center p-3 transition-transform duration-1200 ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:-translate-y-8 will-change-transform">
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-8 pb-12 flex flex-col justify-end pointer-events-none">
                                    <div className="flex flex-col transition-transform duration-1200 ease-[cubic-bezier(0.19,1,0.22,1)] group-hover:-translate-y-6 will-change-transform">
                                        ...
                                        <div className="opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-1200 ease-[cubic-bezier(0.19,1,0.22,1)] delay-150 overflow-hidden h-0 group-hover:h-auto">
